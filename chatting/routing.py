...
from .consumers import test_chat_connect, test_chat_disconnect, test_chat_message
...
channel_routing = [
	...
	route("websocket.connect", test_chat_connect, path=r'^/chat_test/$'),
	route("websocket.disconnect", test_chat_disconnect, path=r'^/chat_test/$'),
	route("websocket.receive", test_chat_message, path=r'^/chat_test/$'),
